...
**💪 FitNova AI** — AI Fitness Platform

**💰 Finova AI** — AI Finance Platform

**📚 StudyFlow AI** — AI Education Platform

**🤖 LifeHub AI** — AI Productivity Platform
...
**🎤 InterviewAI** — Career Development Platform
...
`C++` `OOP` `Game Logic` `Problem Solving`
...
My goal is to become a **Software Engineer & AI Engineer** specializing in:

**Artificial Intelligence • AI Agents • Full-Stack Development • Software Architecture • Cloud Technologies**

I aim to build innovative products, contribute to open-source projects, and develop intelligent software that solves meaningful real-world problems.
